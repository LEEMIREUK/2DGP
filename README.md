...
>#### 프로젝트 소감
>2D 게임프로그래밍 텀프 기획 했을 때 지금 내가 할 수 있는 능력에서 최대한 끌어모아서 프로젝트를 진행해보자는 마음가짐을 가지고 시작하였습니다.   
>간이 지나면서 조금씩 욕심이 생겨 추가구현을 하게되었고 그만큼 시간도 많이 투자하였습니다.    
>파이썬이 익숙하지 않아서 코딩하는 과정에 있어서 처음에 오류를 많이 발생해서 많이 고생을 했습니다.   
>그래도 꾸준히 해보면서 시행착오를 겪어보니 결국 해결하기도 하였습니다. 진행이 시작되고 8주 후 지금 빌드를 해서 게임을 실행했을때 뿌듯했습니다.
